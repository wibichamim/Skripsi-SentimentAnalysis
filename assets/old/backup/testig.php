...
{
$this -> entropy_postif_sentimen_like();
$this -> entropy_postif_sentimen_notlike();
$this -> entropy_negatif_sentimen_like();
$this -> entropy_negatif_sentimen_notlike();
$this -> entropy_kata();
$this -> set_info_gain();
 ...
 public function entropy_set()
{
  ...
  $neg = mysqli_query($koneksi,"select count(id_training) as negatif FROM data_train where sentimen='N' ");
...
public function entropy_postif_sentimen_like()
{
  include 'koneksi.php';
...
function entropy_postif_sentimen_notlike()
...
function entropy_negatif_sentimen_like()

{
  include 'koneksi.php';
      ...
      while ($row_kata = mysqli_fetch_array($query)) {
$a = $row_kata['nama_kata'];
    $querylike = mysqli_query($koneksi,"SELECT count(id_training) as jumlahpos FROM `data_train` where tweet_preprocessing LIKE '%" .$row_kata['nama_kata'] ."%' and sentimen='N'");
        while($datapositif = mysqli_fetch_array($querylike))
        {
        $hasila = $datapositif['jumlahpos'];
...
while ($row_kata = mysqli_fetch_array($query)) {
  $a = $row_kata['nama_kata'];
    ...
    $querylike = mysqli_query($koneksi,"SELECT count(id_training) as jumlahpos FROM `data_train` where tweet_preprocessing not LIKE '%" .$row_kata['nama_kata'] ."%'and sentimen='N'");
        while($datapositif = mysqli_fetch_array($querylike))
        {
        $hasila = $datapositif['jumlahpos'];
...
//$newcount -> entropy_postif_sentimen_like();
//echo "<br>";
//$newcount -> entropy_postif_sentimen_notlike();
//echo "<br>";
//$newcount -> entropy_negatif_sentimen_like();
//echo "<br>";
//echo $newcount -> entropy_negatif_sentimen_notlike();
