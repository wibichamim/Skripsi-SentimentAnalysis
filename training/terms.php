                        ...
                        <ul class="metismenu" id="menu">                            
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                     ...
                                     <li class="active"><a href="">Bobot Terms</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <h4 class="header-title">Bobot Terms</h4>
...
<div class="justify-content-between">
        ...
        ?>
            <tr>
                ...
                <td>
                <?php
                     $prob_dokumen_positif= $data['bobot_bayes_positif'];
                     $prob_dokumen_netral= $data['bobot_bayes_netral'];
                     $prob_dokumen_negatif= $data['bobot_bayes_negatif'];
                     $terms = $data['nama_kata'];
                     $tf = $data['bobot_tf'];
                     $tfidf = $data['bobot_tfidf'];
                         ...
                         if($probabilitas_terbesar == $prob_dokumen_positif)
                         {
                            echo "POSITIF";
                         }
                ...
                <td><?php echo $data['bobot_tf'];  ?></td>  
                <td><?php echo $data['bobot_idf'];  ?></td>		
                <td><?php echo $data['bobot_tfidf'];  ?></td>		
    ...
    <div class=" pull-right"><br>
        <a href="resetterms"><input class="btn btn-flat btn-danger mb-3" type="button" value="Reset"></a>
    </div>

    <div class=" pull-right"><br>     &nbsp;                 &nbsp;                  </div>

    <div class=" pull-right"><br>
        <a href="../tfidf/"><input class="btn btn-flat btn-primary mb-3" type="button" value="Process"></a>
    </div>
</div>
